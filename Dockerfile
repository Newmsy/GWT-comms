...
WORKDIR /src/.
COPY ["Hybrid.Working.Web/Hybrid.Working.Web.csproj", "."]
...
COPY . .
WORKDIR "/src/."
RUN dotnet build "Hybrid.Working.Web/Hybrid.Working.Web.csproj" -c Release -o /app/build

FROM build AS publish
RUN dotnet publish "Hybrid.Working.Web/Hybrid.Working.Web.csproj" -c Release -o /app/publish
